...
function nav() {
    ...
    document.getElementById('vidio1').addEventListener('click', function(){
        window.open('https://www.youtube.com/watch?v=vvuCWGLIjMY')
    });

    document.getElementById('vidio2').addEventListener('click', function(){
        window.open('https://www.youtube.com/watch?v=PJoXvbnAbmA')
    });
